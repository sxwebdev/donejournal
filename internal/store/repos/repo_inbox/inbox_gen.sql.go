...
INSERT INTO inbox (id, data, additional_data, user_id)
	VALUES (?, ?, ?, ?)
	RETURNING id, data, json(additional_data), user_id, created_at, updated_at
`
...
SELECT id, data, json(additional_data), user_id, created_at, updated_at FROM inbox WHERE id=? LIMIT 1
`
